...
const emit = defineEmits(['changeVisibility', 'remove']);
...
watch(() => props.point.is_visible, (newValue) => {
    local_is_visible.value = newValue;
});
</script>
    ...
    <tr class="even:bg-gray-100 h-28">
        ...
        <td class="py-2 px-4 text-center">
            ...
            <button class="mx-1" @click="$emit('changeVisibility', id)">
                <svg v-if="local_is_visible" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <button class="mx-1" @click="$emit('remove', id)">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
